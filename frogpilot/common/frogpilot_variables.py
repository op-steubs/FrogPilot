...
class FrogPilotVariables:
  ...
  def update(self, holiday_theme, started):
    ...
    toggle.aol_brake_hold = toggle.always_on_lateral_set and (params.get_bool("AOLBrakeHold") if tuning_level >= level["AOLBrakeHold"] else default.get_bool("AOLBrakeHold"))
