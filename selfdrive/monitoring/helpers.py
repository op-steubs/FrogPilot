...
class DRIVER_MONITOR_SETTINGS:
  def __init__(self):
    ...
    # WARNING: Modified values below will ban you from comma servers
    self._DISTRACTED_PRE_TIME_TILL_TERMINAL = 10.  # default: 8.
    self._DISTRACTED_PROMPT_TIME_TILL_TERMINAL = 10.  # default: 6.
    ...
    # WARNING: Modified values below will ban you from comma servers
    self._MAX_TERMINAL_ALERTS = 30  # default: 3 - not allowed to engage after N terminal alerts
    self._MAX_TERMINAL_DURATION = int(900 / self._DT_DMON)  # default: 30 - not allowed to engage after Ns of terminal alerts
